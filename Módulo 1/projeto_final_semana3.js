...
do {
    ...
    let personagem = {
        nome: "Juan Carlos",
        resistencia: 30, //STATUS DE RESISTENCIA
        saude: 20, //STATUS DE SAUDE
        respeito: 30, //STATUS DE RESPEITO
        itens: [],
        amigos: [],
    };
    ...
    let tempo = {
        ...
        // MÉTODO PARA CONTROLAR AS HORAS
        addHora: function (hora) {
            console.log("\n\nPressione [1] para avançar as horas.");
        let passaHoras = +prompt();
        while (passaHoras != 1){
            console.log("Erro!");
            console.log("Digite [1] para avançar as horas.");
            passaHoras = +prompt();
        }
            this.hora += hora;
            this.zerar_tempo();
        ...
        // MÉTODO PARA ZERAR OS DIAS QUANDO VIRA A NOITE
        zerar_tempo: function () {
            if (this.hora >= 22) {
                this.hora = 6;
                this.dia++;
            }
    ...
    // FUNÇÃO PARA RANDOMIZAR COM 2 ELEMENTOS
    ...
    // FUNÇÃO PARA RANDOMIZAR COM 3 ELEMENTOS
    ...
    // LAÇO PARA REPETIR OS DIAS DO JOGO
    for (contadorDias = 0; contadorDias < diasRestantes; contadorDias++) {
        ...
        tempo.addHora(1); //ADICIONANDO A HORA PASSADA
        ...
        if (personagem.respeito <= 20) {
            ...
            if (pgt == 1 && personagem.resistencia >= 40) {
                console.log(
            ...
            } else if (pgt == 1 && personagem.resistencia <= 30) {
                console.log(
        ...
        console.log(
            "Chegamos ao café da manhã, e estão servindo pão com manteiga, leite e café.",
        );
        tempo.addHora(2);
        ...
        // VALIDAÇÃO SOBRE AS ESCOLHAS DO BANHO DE SOL DA TARDE
        while (
            escolhasBds2 != 1 &&
            escolhasBds2 != 2 &&
            escolhasBds2 != 3 &&
        ...
        // ESCOLHAS DO BANHO DE SOL DA TARDE
        if (escolhasBds2 == 1) {
            console.log("Você escolheu jogar futebol.");
            if (escolhaFutebol == true) {
                console.log(
                    "Você tenta jogar, mas como já jogou mais cedo acaba não conseguindo",
                );
                personagem.saude -= 20;
                console.log(`Sua saúde agora é de ${personagem.saude}`);
                if (personagem.saude == 0) {
        ...
        if (escolhasBds2 == 2) {
            ...
            if (escolhaAcademia == true) {
                ...
                personagem.resistencia -= 20;
                console.log(
                    `Sua resistência agora é de ${personagem.resistencia}`,
                );
        ...
        if (escolhasBds2 == 3) {
            ...
            if (random_baralho2 == 0) {
                ...
                if (escolhaBaralho1 == 1 && personagem.resistencia >= 30) {
                    console.log(
                        "Uau, que resistência. Você deu um surra nele!",
                    );
                    personagem.respeito += 10;
                    personagem.saude -= 5;
        ...
        console.log(
            'É final de tarde, e já estão servindo as "quentinhas" do jantar.',
        );
        tempo.addHora(1);
        ...
        if (escolhasNoite == 1) {
            ...
            if (personagem.respeito <= 20) {
                ...
                console.log("Você perdeu o jogo!");
                break;
            } else if (personagem.respeito <= 20 &&
        ...
        console.log("FINAL DO DIA!"); // 22:00 HRS
        console.log(
            "Hora de dormir, você sobreviveu a mais um dia na prisão.",
        );
        console.log();
        tempo.zerar_tempo();
        console.clear();
    ...
    if (contadorDias == diasRestantes){
        console.log("\n\n\nParabéns! Você fez Juan Carlos sobreviver e ganhou o jogo!")
    }

    console.log(
        "\nDeseja jogar novamente? \n\nPressione 1 para SIM ou Qualquer tecla para encerrar.",
    );

    continuar = +prompt();
    
} while (continuar == 1) // LAÇO PARA REPITIR O JOGO AO FINALIZAR
